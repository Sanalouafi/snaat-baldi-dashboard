        ...
        <div class="sidebar pe-4 pb-3">
            <nav style="background: #28323A;" class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="materiels.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Materiels</a>
                                    ...
                                    <div class="container d-flex justify-content-center" style="margin-top:10%;">
                                        <form action="" method="post" style="width:50vw; min-width:300px;">
                                            <div class="col d-flex justify-content-center gap-5">
                                                ...
                                                <input type="text" class="form-control" name="nom" placeholder="nom de materiel" value="<?php echo $row['nom'] ?>">
                                            ...
                                            <div class="row ms-1 mt-4 justify-content-end">
                                                ...
                                                <a href="materiels.php" class="btn btn-danger col-3">Cancel</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
